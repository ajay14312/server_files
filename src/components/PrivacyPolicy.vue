        ...
        <section>
            <div id="" class="navbar-collapse ">
                <ul class="navbar-left">
                    <li class="link"><a href="#infoCo">Information that we collect about you</a></li>
                    <li class="link"><a href="#infoUs">How do we use your information</a></li>
                    <li class="link"><a href="#infoPro">Do we use 'cookies'?</a></li>
                    <li class="link"><a href="#coUs">Third-party links</a></li>
                    <li class="link"><a href="#trDi">Google</a></li>
                    <li class="link"><a href="#trLi">COPPA (Children Online Privacy Protection Act)</a></li>
                    <li class="link"><a href="#gooAd">Fair Information Practices</a></li>
                    <li class="link"><a href="#calOppa">CAN SPAM Act</a></li>
                    <li class="link"><a href="#ourCon">Our Contact Information</a></li>
                </ul>
            </div>
            <hr>
            <span id="infoCo"></span>
            <div class="innerText">This privacy policy has been compiled to better serve those who are concerned with how their 'Personally identifiable information' (PII) is being used online. PII, as used in US privacy law and information security, is information that can be used on its own or with other information to identify, contact, or locate a single person, or to identify an individual in context. Please read our privacy policy carefully to get a clear understanding of how we collect, use, protect or otherwise handle your Personally Identifiable Information in accordance with our website.<br></div>
                <br>
                <div><h3>Information that we collect about you</h3></div><br>
                <div><h6>Customers and Website Users</h6></div>
                <div class="grayText"><strong>Information Provided by You Upon Registration and/or Making a Purchase</strong></div><br>
                <div class="innerText">When you register for an account on a Site and/or purchase a product or service from us, we collect information that allows us to identify you, such as:</div><br>
                <div class="innerText">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong>•</strong> Name</div>
                    <div class="innerText">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong>•</strong> E-mail address</div>
                    <div class="innerText">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong>•</strong> Address (where entered as part of a “business/location scan”)</div>
                    <div class="innerText">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong>•</strong> ZIP/Postal Code</div>
                    <div class="innerText">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong>•</strong> Home Phone</div>
                    <div class="innerText">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong>•</strong> Mobile Phone</div>
                    <div class="innerText">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong>•</strong> Credit Card Number</div>
                    <div class="innerText">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong>•</strong> Billing Address</div>
                    <div class="innerText">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong>•</strong> Submit Local login details (username and password)</div>
                <div class="grayText"><strong>Information Provided When You Contact Us.</strong></div><br>
                <div class="innerText">We also collect personal information that you voluntarily provide to us when you contact us with a question or comment about our products and services, download our whitepapers or sign up for product demonstrations or events.  Typically, this includes:</div><br><br>
                    <div class="innerText">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong>•</strong> Name</div>
                    <div class="innerText">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong>•</strong> E-mail address</div>
                    <div class="innerText">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong>•</strong> Organization Name</div>
                    <div class="innerText">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong>•</strong> Phone Number</div>
                    <div class="innerText">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong>•</strong> Information about your position</div>
                    <div class="innerText">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong>•</strong> Information about your interests and preferences</div>
                    <div class="innerText">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong>•</strong> Content of the communication</div><br>
                <span id="infoUs"></span>
                ...
                <div class="innerText"> We may use the information we collect from you when you register, make a purchase, sign up for our newsletter, respond to a survey or marketing communication, surf the website, or use certain other site features in the following ways:<br><br></div>
                    ...
                    <div class="innerText">Our website is scanned on a regular basis for security holes and known vulnerabilities in order to make your visit to our site as safe as possible.<br><br></div>
                        <div class="innerText">We use regular Malware Scanning.<br><br></div>
                            ...
                            <div class="innerText">Personal information is collected on SSL secure pages</div><br>
                            ...
                            <div class="innerText"><br>You can choose to have your computer warn you each time a cookie is being sent, or you can choose to turn off all cookies. You do this through your browser (like Internet Explorer) settings. Each browser is a little different, so look at your browser's Help menu to learn the correct way to modify your cookies.<br></div><br>
                                <div class="innerText">If you disable cookies off, some features will be disabled It won't affect the user's experience that make your site experience more efficient and some of our services will not function properly.</div><br>
                                ...
                                <div class="innerText">We do not sell, trade, or otherwise transfer to outside parties your personally identifiable information unless we provide users with advance notice. This does not include website hosting partners and other parties who assist us in operating our website, conducting our business, or serving our users, so long as those parties agree to keep this information confidential. We may also release information when it's release is appropriate to comply with the law, enforce our site policies, or protect ours or others' rights, property, or safety. <br><br> However, non-personally identifiable visitor information may be provided to other parties for marketing, advertising, or other uses. </div><br>
                                    <span id="coUs"></span>
                ...
                Users can set preferences for how Google advertises to you using the Google Ad Settings page. Alternatively, you can opt out by visiting the Network Advertising initiative opt out page or permanently using the Google Analytics Opt Out Browser add on.</div><br>
                                                            ...
                                                            <div class="innerText">The Fair Information Practices Principles form the backbone of privacy law in the United States and the concepts they include have played a significant role in the development of data protection laws around the globe. Understanding the Fair Information Practice Principles and how they should be implemented is critical to comply with the various privacy laws that protect personal information.<br><br></div>
                                                                ...
                                                                <div class="innerText"><br>We also agree to the Individual Redress Principle, which requires that individuals have a right to pursue legally enforceable rights against data collectors and processors who fail to adhere to the law. This principle requires not only that individuals have enforceable rights against data users, but also that individuals have recourse to courts or government agencies to investigate and/or prosecute non-compliance by data processors.</div><br>
                                                                    ...
                                                                    <div class="innerText">The CAN-SPAM Act is a law that sets the rules for commercial email, establishes requirements for commercial messages, gives recipients the right to have emails stopped from being sent to them, and spells out tough penalties for violations.<br><br></div>
                                                                        ...
                                                                        <div class="innerText"><strong><br>If at any time you would like to unsubscribe from receiving future emails, you can email us at</strong></div> and we will promptly remove you from <strong>ALL</strong> correspondence.<br>
                                                                        ...
                                                                        <div class="innerText">If there are any questions regarding this privacy policy you may contact us using the information below.<br><br></div>
                                                                            <div class="innerText">Submitlocal.com</div>
                                                                            <div class="innerText">1013 centre RD Ste 403s</div>Wilmington, DE 19805
                                                                            <div class="innerText">USA</div>
                                                                            <div class="innerText">privacy@submitlocal.com</div>
                                                                            <br>
                                                                                                             
                                                                            <!-- <div class="innerText">844-228-2852</div><div class="innerText"><br>Last Edited on 2016-03-21</div> -->
        </section>
    </div>
    <section class="getit">
        <div class="container">
